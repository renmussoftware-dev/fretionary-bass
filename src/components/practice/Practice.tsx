  ...
  return (
    <View style={styles.wrap}>
      <Text style={styles.intro}>
        Sharpen your fretboard knowledge — drill notes, find positions, master one string at a time. Uses your current tuning.
      </Text>
...
const styles = StyleSheet.create({
  ...
  modePro: { fontSize: 10, fontWeight: '800', color: COLORS.accent, letterSpacing: 0.6 },
